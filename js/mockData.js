...
const MOCK_DATA = {
  ...
  movies: [
    ...
    },
    {
      ...
      rating: "U",
      imdb: 8.9,
      synopsis: "When 10-year-old Meera discovers a magical golden lantern in her grandmother's attic, she is transported to the ancient kingdom of Akashdeep — where only the light of friendship can defeat the shadow that threatens to consume the realm.",
      cast: ["Meera (voice)", "Grandma Lakshmi (voice)", "Prince Arjun (voice)"],
